<div class="col-3  col_droite-profil">
    <div class="container">
        <div class="info-col-droite">
            ...
            <h2>Simplement du faux texte</h2>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed orci risus,
                lacinia eu ante quis, fringilla, Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed orci risus,
                lacinia eu ante quis, fringilla</p>
        </div>
        <div class="info-col-droite">
            <h2>Instruction pour annoncer</h2>
